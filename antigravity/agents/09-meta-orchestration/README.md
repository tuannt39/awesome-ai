...
AI-powered workspace featuring autonomous agents, real-time collaboration, and workflow automation. Provides an MCP server for Antigravity CLI integration, enabling task management, project orchestration, and multi-agent workflows directly from your development environment.

**Use when:** Managing tasks and projects with AI agents, automating workflows across teams, orchestrating multi-agent collaboration, or integrating AI-powered project management into Antigravity CLI via MCP. Website: [taskade.com](https://www.taskade.com)
