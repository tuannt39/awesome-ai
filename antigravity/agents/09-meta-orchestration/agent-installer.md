...
4. Install agents to global (`~/.Antigravity/agents/`) or local (`.Antigravity/agents/`) directory
...
1. Ask if they want global installation (`~/.Antigravity/agents/`) or local (`.Antigravity/agents/`)
2. For local: Check if `.Antigravity/` directory exists, create `.Antigravity/agents/` if needed
...
**You:**
1. Ask: "Install globally (~/.Antigravity/agents/) or locally (.Antigravity/agents/)?"
2. Download from GitHub
3. Save to chosen directory
4. Confirm: "✓ Installed python-pro.md to ~/.Antigravity/agents/"
