...
mkdir -p ~/.gemini/antigravity/rules/ecc

# Install common rules (required for all projects)
cp -r rules/common ~/.gemini/antigravity/rules/ecc/

# Install language-specific rules based on your project's tech stack
cp -r rules/typescript ~/.gemini/antigravity/rules/ecc/
cp -r rules/angular ~/.gemini/antigravity/rules/ecc/
cp -r rules/python ~/.gemini/antigravity/rules/ecc/
cp -r rules/golang ~/.gemini/antigravity/rules/ecc/
cp -r rules/web ~/.gemini/antigravity/rules/ecc/
cp -r rules/swift ~/.gemini/antigravity/rules/ecc/
cp -r rules/php ~/.gemini/antigravity/rules/ecc/
cp -r rules/ruby ~/.gemini/antigravity/rules/ecc/
cp -r rules/arkts ~/.gemini/antigravity/rules/ecc/
