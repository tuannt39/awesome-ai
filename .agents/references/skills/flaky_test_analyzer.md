...
**Fix:** Replace with stable locator following priority in `../rules/locator_strategy.md`:
...
**Fix:** Use smart waits as defined in `../rules/selenium_rules.md` and `../rules/playwright_rules.md`:
```java
// Selenium
...
- `../rules/locator_strategy.md` — Locator stability rules
- `../rules/automation_rules.md` — General automation best practices
- `../rules/selenium_rules.md` — Selenium wait strategy
- `../rules/playwright_rules.md` — Playwright auto-waiting
