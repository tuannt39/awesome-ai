...
description: Đẩy kết quả test automation (Playwright/JUnit/Allure) lên Xray Test Management trên Jira.
---
...
> - `../references/skills/jira_integration.md` — Kiến thức tích hợp Jira/Xray
...
1. **Kiểm tra prerequisites:**
   - Đọc tài liệu `../references/skills/jira_integration.md` để nắm cấu trúc scripts.
