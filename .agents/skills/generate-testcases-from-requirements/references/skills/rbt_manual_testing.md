...
- Cần sinh automation code → dùng `./qa_automation_engineer.md`
- Cần inspect DOM / sinh locator → dùng `./ui_debug_agent.md` / `./smart_locator_agent.md`
- Chỉ cần sinh test data → dùng `./test_data_generator.md`
