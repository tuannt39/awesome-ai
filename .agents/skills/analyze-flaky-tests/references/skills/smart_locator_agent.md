...
> **Note:** For detailed rules, refer to `../rules/locator_strategy.md`.
...
> **Note:** For detailed rules, refer to `../rules/playwright_rules.md`.
...
> **Note:** For detailed rules, refer to `../rules/selenium_rules.md`.
...
> **Note:** For detailed rules, refer to `../rules/appium_rules.md`.
...
- `../rules/playwright_rules.md` — Playwright-specific locator rules
- `../rules/selenium_rules.md` — Selenium-specific locator rules
- `../rules/appium_rules.md` — Appium-specific locator rules
