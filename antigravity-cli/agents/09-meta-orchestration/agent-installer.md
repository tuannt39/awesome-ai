...
4. Install agents to global (`~/.gemini/antigravity-cli/agents/`) or local (`.gemini/antigravity-cli/agents/`) directory
...
1. Ask if they want global installation (`~/.gemini/antigravity-cli/agents/`) or local (`.gemini/antigravity-cli/agents/`)
2. For local: Check if `.gemini/antigravity-cli/` directory exists, create `.gemini/antigravity-cli/agents/` if needed
...
**You:**
1. Ask: "Install globally (~/.gemini/antigravity-cli/agents/) or locally (.gemini/antigravity-cli/agents/)?"
2. Download from GitHub
3. Save to chosen directory
4. Confirm: "✓ Installed python-pro.md to ~/.gemini/antigravity-cli/agents/"
