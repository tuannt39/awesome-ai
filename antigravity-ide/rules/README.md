...
>
> Use the ECC-owned namespace below for user-level Antigravity installs. Flat
...
mkdir -p ~/.gemini/antigravity-ide/rules/ecc

# Install common rules (required for all projects)
cp -r rules/common ~/.gemini/antigravity-ide/rules/ecc/

# Install language-specific rules based on your project's tech stack
cp -r rules/typescript ~/.gemini/antigravity-ide/rules/ecc/
cp -r rules/angular ~/.gemini/antigravity-ide/rules/ecc/
cp -r rules/python ~/.gemini/antigravity-ide/rules/ecc/
cp -r rules/golang ~/.gemini/antigravity-ide/rules/ecc/
cp -r rules/web ~/.gemini/antigravity-ide/rules/ecc/
cp -r rules/swift ~/.gemini/antigravity-ide/rules/ecc/
cp -r rules/php ~/.gemini/antigravity-ide/rules/ecc/
cp -r rules/ruby ~/.gemini/antigravity-ide/rules/ecc/
cp -r rules/arkts ~/.gemini/antigravity-ide/rules/ecc/
